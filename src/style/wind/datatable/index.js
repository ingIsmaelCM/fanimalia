  ...
  column: {
    ...
    bodycell: ({ props, context, state, parent }) => ({
      class: [
        ...
        // Spacing
        { "py-2 px-2": context?.size === "small" && !state["d_editing"] },
        { "py-2 px-4": context?.size === "large" && !state["d_editing"] },
        {
          "py-3.5 px-3":
            context?.size !== "large" &&
            context?.size !== "small" &&
    ...
    filteraddrulebutton: {
      root: {
        class: [
          ...
          // Sizes & Spacing
          " px-2.5 py-1.5 min-w-[2rem] w-full",
    ...
    filterremovebutton: {
      root: {
        class: [
          ...
          // Sizes & Spacing
          " px-2.5 py-1.5 min-w-[2rem] w-full mt-2",
